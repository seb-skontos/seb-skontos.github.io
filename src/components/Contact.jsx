...
const Contact = () => (
  <section id="contact" className="bg-gray-100 dark:bg-gray-900 py-16 text-center text-gray-900 dark:text-gray-100 px-8 md:px-20 lg:px-40">
    ...
    <div className="flex justify-center space-x-6 mb-6">
      ...
      <a href="https://github.com/ssko7098" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-500 text-2xl transition-transform transform hover:scale-110">
        <FaGithub />
      </a>
